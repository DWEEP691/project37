class Question {
  ...
  style() {
    this.input1.class("di");
    this.input2.class("di");
    this.button.class("db");
    this.button2.class("db");
    this.gr.class("greeting");
  }
  ...
  hmp() {
    this.button.mousePressed(()=>{
      ...
      </br>wait for another player to answer`;
      this.gr.html(message);
